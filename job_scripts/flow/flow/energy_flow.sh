...
#SBATCH --job-name=EFM-base-effbs_@BZ-lr_@LR_fp32_egrad_300_cos_sched
#SBATCH --output=logs/slurm/img_256/EFM-base-effbs_@BZ-lr_@LR_fp32_egrad_300_cos_sched%A-%a.log
RUN_NAME="EFM-base-effbs_@BZ-lr_@LR_fp32_egrad_300_cos_sched"
...
--wandb_project "energy_diffusion_final3" \
\
--preview \
--preview_interval 20 \
