...
#SBATCH --job-name=SFM-base-effbs_@BZ-lr_@LR_fp32_cos_sched
#SBATCH --output=logs/slurm/img_256/SFM-base-effbs_@BZ-lr_@LR_fp32_cos_sched%A-%a.log
RUN_NAME="SFM-base-effbs_@BZ-lr_@LR_fp32_cos_sched"
