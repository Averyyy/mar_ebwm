...
torchrun --nproc_per_node=1 --nnodes=1 --node_rank=0 --master_addr=localhost --master_port=5748 main_mar.py \
  --run_name mar-base-1k-64-1e-4-tiny-ptshard \
  --img_size 64 \
  --vae_path /work/hdd/bdta/aqian1/mar_ebwm/pretrained_models/vae/kl16.ckpt \
  --vae_embed_dim 16 --vae_stride 16 --patch_size 1 \
  --model mar_base  --model_type mar \
  --diffloss_d 3 --diffloss_w 1024 \
  --epochs 10000 --warmup_epochs 1000 \
  --batch_size 4096 --grad_accu 1 --blr 1.0e-4 --lr_schedule cosine \
  --diffusion_batch_mul 4 \
  --use_cached \
  --cached_format ptshard \
  --cached_path /work/hdd/bdta/aqian1/data/cached-imagenet1k-64-ptshard \
  --output_dir /work/hdd/bdta/aqian1/mar_ebwm_coding/output/mar-base-1k-64-1e-4-tiny-ptshard \
  --resume /work/hdd/bdta/aqian1/mar_ebwm_coding/output/mar-base-1k-64-1e-4-tiny-ptshard \
  --preview \
