#!/bin/bash
# ===== PURPOSE: Standard Diffusion Model training on ImageNet-64 with large model =====
# ===== USAGE: bash slurm/slurm_exec.sh ncsa_gh200 slurm/job_configs/energy_diffusion/img64/train_SDM_large_64.sh =====
