#!/bin/bash
# ===== PURPOSE: Energy Diffusion Model training on ImageNet-64 with large model and learning rate grid search =====
# ===== USAGE: bash slurm/slurm_exec.sh ncsa_gh200 slurm/job_configs/energy_diffusion/img64/train_EDM_large_64.sh =====
# ===== NOTE: Remeber to change --array to the number of jobs you want to run =====

#SBATCH --job-name=EDM-large-lr-search
#SBATCH --array=0-2
#SBATCH --output=${REPO_ROOT}/logs/slurm/EDM-large-lr-search/%A/EDM-large-%a.out
