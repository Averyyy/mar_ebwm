...
#SBATCH --job-name=EDM-small-effbs_@BZ-lr_@LR
#SBATCH --output=logs/slurm/img_256/EDM-small-effbs_@BZ-lr_@LR%A-%a.log
RUN_NAME="EDM-small-effbs_@BZ-lr_@LR"
...
# TODO check new script line by line, check make sure have all params from original slurm script exact same here
